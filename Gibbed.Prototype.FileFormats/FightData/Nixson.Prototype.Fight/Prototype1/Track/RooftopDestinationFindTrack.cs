...
namespace Nixson.Prototype.Fight.Prototype1.Track
{
	...
	public class RooftopDestinationFindTrack : P1Track
	{
		...
		public RooftopDestinationFindTrack.HeightDiferenceType HeightDifferenceCheck { get; set; }
		...
		public RooftopDestinationFindTrack.CameraVisibilityType CameraVisibility { get; set; }
		...
		public override void Serialize(Stream output, Endian endianess)
		{
			...
			output.WriteValueF32(this.EdgeReserveRadius, endianess);
			output.WriteValueF32(this.MinDistanceForEdge, endianess);
			output.WriteValueF32(this.HeightForEdge, endianess);
			output.WriteValueF32(this.EdgeCloserThan, endianess);
			...
			BaseProperty.SerializePropertyEnum<RooftopDestinationFindTrack.HeightDiferenceType>(output, endianess, this.HeightDifferenceCheck);
			...
			BaseProperty.SerializePropertyEnum<RooftopDestinationFindTrack.CameraVisibilityType>(output, endianess, this.CameraVisibility);
		...
		public override void Deserialize(Stream input, Endian endianess)
		{
			...
			this.EdgeReserveRadius = input.ReadValueF32(endianess);
			this.MinDistanceForEdge = input.ReadValueF32(endianess);
			this.HeightForEdge = input.ReadValueF32(endianess);
			this.EdgeCloserThan = input.ReadValueF32(endianess);
			...
			this.HeightDifferenceCheck = BaseProperty.DeserializePropertyEnum<RooftopDestinationFindTrack.HeightDiferenceType>(input, endianess);
			...
			this.CameraVisibility = BaseProperty.DeserializePropertyEnum<RooftopDestinationFindTrack.CameraVisibilityType>(input, endianess);
			...
			this.OffsetLOF.Deserialize(input, endianess);
			...
			this.WhenFound.Deserialize(input, endianess);
